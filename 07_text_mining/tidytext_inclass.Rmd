...
#! it separates words with spaces " "
...
#! it separates words with punctuation " "
...
# sometimes there are "stop words" like "the, it, is". we can filter them out
View(ah_count)
#Quick plot 
...
#3 is the id of Kennedy's inauguration
...
#tf = term frequency
#idf = inverse document frequency (idf), which decreases the weight for commonly used words and increases the weight for words that are not used very much in a collection of documents.
#tf-idf : the two factors multiplied.
