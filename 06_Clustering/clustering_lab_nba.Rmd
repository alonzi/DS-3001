...
NROW(standardized_complete_set)
...
NROW(salary_kmeans_obj$cluster)
...
NROW(salary_group_join_clusters)
NROW(standardized_complete_set)

str(salary_group_join_clusters)
# View(salary_group_join_clusters)
NROW(standardized_complete_set)
View(standardized_complete_set)

str(salary_group_join_clusters)
str(standardized_complete_set)
...
# View(salaries)
# nba_data_with_salary_group = clust_data_nba
# View(nba_data_with_salary_group)
...
# Points and Salary
# length(salary_clusters_nba)
# length(standardized_complete_set$color)
# View(standardized_complete_set)
View(standardized_complete_set)
NROW(standardized_complete_set$color)
NROW(salary_clusters_nba)
